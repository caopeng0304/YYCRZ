...
public class FileConvertUtil {
	...
	public static InputStream convertNetFiles(MinioTemplate minioTemplate, String fileName, String suffix) throws Exception {
		InputStream inputStream = minioTemplate.getObject(CommonConstants.BUCKET_NAME, fileName);
		return covertCommonByStream(inputStream, suffix);
	}
	...
	public static void main(String[] args) throws Exception {
		try{
			convertNetFile("http://192.168.2.183:9000/booster/111.doc", ".pdf");
	...
	public static String[] split(String url,String s){
		return url.split(s);
	}
}
