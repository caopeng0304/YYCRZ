...
import com.sinosoft.ie.booster.infection.mapper.TracMapper;
 ...
 */
@Service
public class TracServiceImpl extends ServiceImpl<TracMapper, TracEntity> implements TracService {
}