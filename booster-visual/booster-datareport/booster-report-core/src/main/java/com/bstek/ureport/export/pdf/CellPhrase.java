...
public class CellPhrase extends Phrase {
    public static final Map<String,String> FONT_PATH_MAP =new HashMap<String,String>();
    ...
    public Font buildPdfFont(Cell cell) throws IOException, DocumentException {
        ...
        String fontpath = FONT_PATH_MAP.get(fontName);
        if (StringUtils.isBlank(fontpath)){
            FONT_PATH_MAP.put("宋体","com/bstek/ureport/font/songti/SIMSUN.TTC");
            FONT_PATH_MAP.put("楷体","com/bstek/ureport/font/kaiti/SIMKAI.TTF");
            FONT_PATH_MAP.put("微软雅黑","com/bstek/ureport/font/yahei/msyh.ttc");
            FONT_PATH_MAP.put("Times New Roman","com/bstek/ureport/font/timesnewroman/TIMES.TTF");
            FONT_PATH_MAP.put("Impact","com/bstek/ureport/font/impact/IMPACT.TTF");
            FONT_PATH_MAP.put("黑体","com/bstek/ureport/font/heiti/SIMHEI.TTF");
            FONT_PATH_MAP.put("仿宋","com/bstek/ureport/font/fangsong/SIMFANG.TTF");
            FONT_PATH_MAP.put("Courier New","com/bstek/ureport/font/couriernew/COUR.TTF");
            FONT_PATH_MAP.put("Comic Sans MS","com/bstek/ureport/font/comicsansms/COMIC.TTF");
            FONT_PATH_MAP.put("Arial","com/bstek/ureport/font/arial/ARIAL.TTF");
            fontpath = FONT_PATH_MAP.get(fontName);
        }
