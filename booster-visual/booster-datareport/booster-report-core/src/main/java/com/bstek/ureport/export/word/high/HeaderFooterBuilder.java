...
public class HeaderFooterBuilder {
	private static final Pattern HEADER_FOOTER_PATTERN = Pattern.compile("\\$\\[PAGE\\]|\\$\\[PAGES\\]|\\$\\[DATE\\]|\\$\\[TIME\\]");
	...
	private List<String> splitHeaderFooterContent(String info){
		Matcher matcher = HEADER_FOOTER_PATTERN.matcher(info);
