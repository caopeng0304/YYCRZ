...
import com.sinosoft.ie.booster.workflow.mapper.FormLeaveApplyMapper;
 ...
 */
@Service
public class FormLeaveApplyServiceImpl extends ServiceImpl<FormLeaveApplyMapper, FormLeaveApplyEntity> implements FormLeaveApplyService {
	...
	@Override
	public FormLeaveApplyEntity getInfo(Long id) {
		QueryWrapper<FormLeaveApplyEntity> queryWrapper = new QueryWrapper<>();
		queryWrapper.lambda().eq(FormLeaveApplyEntity::getId, id);
		return this.getOne(queryWrapper);
	}

	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void save(Long id, FormLeaveApplyEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
	...
	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void submit(Long id, FormLeaveApplyEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
			entity.setId(IdWorker.getId());
			this.save(entity);
