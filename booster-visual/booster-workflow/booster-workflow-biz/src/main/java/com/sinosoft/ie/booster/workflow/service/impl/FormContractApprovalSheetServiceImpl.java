...
import com.sinosoft.ie.booster.workflow.mapper.FormContractApprovalSheetMapper;
 ...
 */
@Service
public class FormContractApprovalSheetServiceImpl extends ServiceImpl<FormContractApprovalSheetMapper, FormContractApprovalSheetEntity> implements FormContractApprovalSheetService {
	...
	@Override
	public FormContractApprovalSheetEntity getInfo(Long id) {
		QueryWrapper<FormContractApprovalSheetEntity> queryWrapper = new QueryWrapper<>();
		queryWrapper.lambda().eq(FormContractApprovalSheetEntity::getId, id);
		return this.getOne(queryWrapper);
	}

	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void save(Long id, FormContractApprovalSheetEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
	...
	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void submit(Long id, FormContractApprovalSheetEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
			entity.setId(IdWorker.getId());
			this.save(entity);
