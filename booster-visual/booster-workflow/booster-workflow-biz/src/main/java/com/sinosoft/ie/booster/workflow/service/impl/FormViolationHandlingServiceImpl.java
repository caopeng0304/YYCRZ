...
import com.sinosoft.ie.booster.workflow.mapper.FormViolationHandlingMapper;
 ...
 */
@Service
public class FormViolationHandlingServiceImpl extends ServiceImpl<FormViolationHandlingMapper, FormViolationHandlingEntity> implements FormViolationHandlingService {

	@Autowired
	private FlowTaskService flowTaskService;

	@Override
	public FormViolationHandlingEntity getInfo(Long id) {
		QueryWrapper<FormViolationHandlingEntity> queryWrapper = new QueryWrapper<>();
		queryWrapper.lambda().eq(FormViolationHandlingEntity::getId, id);
		return this.getOne(queryWrapper);
	}

	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void save(Long id, FormViolationHandlingEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
	...
	@Override
	@Transactional(rollbackFor = WorkFlowException.class)
	public void submit(Long id, FormViolationHandlingEntity entity) throws WorkFlowException {
		//表单信息
		if (id == null) {
			entity.setId(IdWorker.getId());
			this.save(entity);
