 ...
 * @since 2022-03-31
 */
public class PostgreSqlMetaDataServiceImpl extends AbstractMetaDataService {

	public PostgreSqlMetaDataServiceImpl(String driverClassName, String username, String password, String jdbcUrl) {
