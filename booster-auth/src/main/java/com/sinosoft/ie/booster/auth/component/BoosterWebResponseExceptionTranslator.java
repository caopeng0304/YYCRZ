...
import com.sinosoft.ie.booster.auth.exception.*;
 ...
 */
@Slf4j
public class BoosterWebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new BoosterAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
