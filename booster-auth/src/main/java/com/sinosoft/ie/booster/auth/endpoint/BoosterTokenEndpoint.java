...
public class BoosterTokenEndpoint {
	...
	@Inner
	@PostMapping("/page")
	public R<Page<Object>> tokenList(@RequestBody Map<String, Object> params) {
		// 根据分页参数获取对应数据
		String key = String.format("%sauth_to_access:*", CacheConstants.PROJECT_OAUTH_ACCESS);
		long current = MapUtil.getLong(params, CommonConstants.CURRENT);
		long size = MapUtil.getLong(params, CommonConstants.SIZE);
