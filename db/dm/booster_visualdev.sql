...
CREATE TABLE base_data_interface (
  ...
  response_parameters text,
  db_link_id varchar(100),
  data_type int,
  sort int,
  enabled_flag char(1) DEFAULT 1,
  del_flag char(1) DEFAULT 0,
...
-- ----------------------------
ALTER TABLE base_visual_dev_model_data ADD CONSTRAINT base_visual_dev_model_data_pkey PRIMARY KEY (id);
