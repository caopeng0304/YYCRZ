 ...
 */
@Slf4j
public class BoosterSentinelInvocationHandler implements InvocationHandler {
	...
	BoosterSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			BoosterSentinelInvocationHandler other = (BoosterSentinelInvocationHandler) obj;
