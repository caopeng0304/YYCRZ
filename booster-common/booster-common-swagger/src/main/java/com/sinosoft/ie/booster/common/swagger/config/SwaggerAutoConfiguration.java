package com.sinosoft.ie.booster.common.swagger.config;
...
public class SwaggerAutoConfiguration {
	...
	/**
	 * 移除spring-boot-starter-actuator，因Actuator始终使用基于PathPattern的解析,而不管配置的
	 * 在Spring Boot2.6及更高版本中将Swagger与Actuator一起使用,需要对Springfox进行更改
	 */
	@Bean
